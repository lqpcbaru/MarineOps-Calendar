...
import type { CreateStationCommand, UpdateStationCommand, ListStationsQuery } from '../../modules/stations/application/dtos';
import { JwtAuthGuard } from '../../modules/authentication/api/jwt-auth.guard';
import { PermissionsGuard, RequirePermissions } from '../../modules/authentication/api/permissions.guard';
...
export class AdminStationsController {
  ...
  async getById(@Param('id') id: string) {
    ...
    return {
      ...
      latitude: s.latitude, longitude: s.longitude, timezone: s.timezone,
